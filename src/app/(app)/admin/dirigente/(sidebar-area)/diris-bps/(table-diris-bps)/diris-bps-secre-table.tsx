...
import { DirisBpsTableRow } from './diris-bps-secre-table-row'
import { DirisBpsTableSkeleton } from './diris-bps-secre-table-skeleton'
        ...
        <div className="w-full overflow-x-auto bg-transparent">
          <Table className="w-full text-xs lg:table-fixed">
            ...
            <TableBody className="bg-transparent">
              {isLoading && <DirisBpsTableSkeleton />}
              {result &&
                result.length !== 0 &&
                result.map((lider) => {
                  return <DirisBpsTableRow key={lider.nome} pessoa={lider} />
                })}
