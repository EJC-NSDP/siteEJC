...
export function CardCarouselTrigger({
  ...
  return (
    <Card
      className="text-tertiary flex w-32 cursor-pointer flex-col gap-1 bg-zinc-50 px-1 py-2 text-center shadow-lg aria-selected:-translate-y-2 lg:w-100 lg:gap-6 lg:px-8 lg:py-8 lg:aria-selected:-translate-y-4"
      aria-selected={ariaSelected}
      onMouseEnter={selectCard}
      onClick={selectCard}
    >
      <CardTitle className="flex items-center justify-center">
        <Icon className="text-primary h-4 w-4 lg:h-12 lg:w-12" />
      </CardTitle>
